...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["unitree_g1", "unitree_g1_with_hands", "unitree_h1", "unitree_h1_2",
                 ...
                 "openloong", "tienkung","joyin","joyin_add", "casbot_02", "casbot_02_auto", "marathon_001"],
        default="unitree_g1",
    )
    ...
    # 映射关节顺序
    nd_expected = len(joint_order)  # 关节数量
    vec = np.zeros(nd_expected, dtype=np.float32)
    assigned = 0

    # xml中的关节顺序和json中自己写的顺序进行对齐
